<?php
	...
	//$sql = "INSERT INTO users (HTNO, FIRSTNAME ,LASTNAME , GENDER , COURSE , DEPARTMENT , YEAR , COLLEGE , EMAIL , MOBILE , EVENT1,EVENT2,EVENT3)

	                 //VALUES ('$htno' ,'$fname', '$lname' , '$gender' , '$course' , '$department' , '$year' , '$college' ,'$email' ,'$mobile' , '$event1', '$event2', '$event3')";
